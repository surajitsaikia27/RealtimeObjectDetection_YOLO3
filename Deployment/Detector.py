...
image_test_folder = os.path.join(image_folder, "traffic")

detection_results_folder = os.path.join(image_folder, "trafficout")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="postfix",
        default="_traffic",
        help='Specify the postfix for images with bounding boxes. Default is "_traffic"',
    )

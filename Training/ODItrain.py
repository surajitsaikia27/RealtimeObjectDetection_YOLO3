# -*- coding: utf-8 -*-
"""
Created on Tue Oct  6 00:56:34 2020
...
Image_Folder = os.path.join(Data_Folder, "Source_Images", "OIDsample")
VoTT_Folder = os.path.join(Image_Folder, "trainID")
YOLO_filename = os.path.join(VoTT_Folder, "trainannotation.txt")

Model_Folder = os.path.join(Data_Folder, "Model_Weights")
YOLO_classname = os.path.join(Model_Folder, "data_classIND.txt")
...
if __name__ == "__main__":
    ...
    if True:
        ...
        model.save_weights(os.path.join(log_dir, "trained_weights_industry.h5"))
    ...
    if True:
        ...
        model.save_weights(os.path.join(log_dir, "trained_weights_finalindustry.h5"))
